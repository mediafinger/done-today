...
RSpec.describe Org do
    ...
    it "has many associations" do
      {
        ...
        assoc = described_class.reflect_on_association(assoc_name)
        expect(assoc.macro).to eq(:has_many)
        expect(assoc.options[:dependent]).to eq(dep)
      end

      members_assoc = described_class.reflect_on_association(:members)
      ...
      users_assoc = described_class.reflect_on_association(:users)
  ...
  describe "validations" do
    it "validates presence of name" do
      org = described_class.new(name: nil)
    ...
    it "validates uniqueness of name" do
      ...
      duplicate = described_class.new(name: "Unique Org")
