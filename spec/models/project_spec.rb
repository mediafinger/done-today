...
RSpec.describe Project, type: :model do
  describe "associations" do
    it "has expected associations" do
      org_assoc = Project.reflect_on_association(:org)
      expect(org_assoc.macro).to eq(:belongs_to)

      days_assoc = Project.reflect_on_association(:days)
      expect(days_assoc.macro).to eq(:has_many)
      expect(days_assoc.options[:dependent]).to eq(:destroy)

      part_assoc = Project.reflect_on_association(:participants)
  ...
  describe "validations" do
    ...
    it "validates presence of name" do
      project = Project.new(org: org, name: nil)
