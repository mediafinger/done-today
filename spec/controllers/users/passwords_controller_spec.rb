...
RSpec.describe Users::PasswordsController do
  ...
  describe "GET #edit with invalid token" do
  ...
  describe "GET #edit with valid token" do
  ...
  describe "PATCH #update with matching passwords" do
  ...
  describe "PATCH #update with non-matching passwords" do
    let(:token) { user.generate_token_for(:password_reset) }
